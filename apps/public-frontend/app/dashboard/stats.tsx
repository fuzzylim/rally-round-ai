  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col">
            <div className="text-sm font-medium text-slate-400 mb-1">Total Raised</div>
            <div className="text-2xl font-bold text-white">{stats.totalRaised}</div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col">
            ...
            <div className="mt-1 text-xs text-slate-400">In the next 30 days</div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col">
            <div className="text-sm font-medium text-slate-400 mb-1">Completed Fundraisers</div>
            <div className="text-2xl font-bold text-white">{stats.completedFundraisers}</div>
